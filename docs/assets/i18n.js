...
(function () {
  ...
  window.I18N = {
    ...
    "view.aiexpert": { ko: "🎓 AI Expert", en: "🎓 AI Expert" },

    "ai.title": { ko: "🎓 AI Expert 대상 학회 리스트", en: "🎓 AI Expert Target Conferences" },
    "ai.sub": { ko: "AI 전문가 인증 대상 13개 최상위 학회", en: "The 13 flagship conferences for AI expert recognition" },
    "ai.searchPlaceholder": { ko: "학회명 검색 (예: NeurIPS, ICML)", en: "Search conferences (e.g. NeurIPS, ICML)" },
    "ai.summary.inlist": { ko: "컨퍼런스 리스트 등재", en: "In the conference list" },
    "ai.summary.notinlist": { ko: "컨퍼런스 리스트 미등재", en: "Not in the conference list" },
    "ai.summary.inlistDesc": {
      ko: "선택한 기준 연도({label})의 컨퍼런스 리스트에 포함된 대상 학회입니다.",
      en: "Target conferences included in the {label} conference list.",
    },
    "ai.summary.notinlistDesc": {
      ko: "선택한 기준 연도({label})의 컨퍼런스 리스트에 없는 대상 학회입니다.",
      en: "Target conferences missing from the {label} conference list.",
    },
    "ai.listTitle": { ko: "대상 학회 목록", en: "Target Conferences" },
    "ai.listSub": { ko: "선택한 기준 연도의 컨퍼런스 리스트 등재 여부를 함께 표시합니다", en: "Shows whether each is in the selected year's conference list" },
    "ai.th.no": { ko: "번호", en: "No." },
    "ai.th.abbr": { ko: "약칭", en: "Abbrev." },
    "ai.th.name": { ko: "학회명", en: "Conference" },
    "ai.th.inlist": { ko: "컨퍼런스 리스트", en: "Conference list" },
    "ai.th.nextdl": { ko: "다음 마감", en: "Next deadline" },
    "ai.badge.in": { ko: "✅ 등재", en: "✅ Listed" },
    "ai.badge.out": { ko: "➖ 미등재", en: "➖ Not listed" },
    "ai.noDeadline": { ko: "마감일 미확인", en: "Not announced" },
    "ai.est": { ko: "예상", en: "est." },
    "ai.monthTitle": { ko: "월별 제출 일정", en: "Monthly Submission Schedule" },
    "ai.monthSub": { ko: "현재 추적 중인 마감일을 월별로 정리했습니다 (AoE 기준)", en: "Currently tracked deadlines grouped by month (AoE)" },
    "ai.monthEmpty": { ko: "표시할 마감일이 없습니다.", en: "No deadlines to display." },
    "ai.sourceNote": {
      ko: "※ 대상 학회 리스트는 매년 갱신됩니다. 마감일은 각 학회 공지 기준이며 '예상'은 직전 개최 패턴 기반 추정치입니다.",
      en: "※ The target list is updated yearly. Deadlines follow each venue's announcement; 'estimated' items are projected from prior editions.",
    },
    ...
    "board.year": { ko: "기준 연도", en: "Reference year" },
    ...
    "unit.itemsParen": { ko: "({n}개)", en: "({n})" },
    "unit.journalsCount": { ko: "{n}개 저널", en: "{n} journals" },
    "unit.confCount": { ko: "{n}개 학회", en: "{n} conferences" },

    "journal.title": { ko: "최우수/우수 저널 목록", en: "Top-tier / Excellent Journals" },
    "journal.searchPlaceholder": { ko: "저널명 검색 (예: Nature, IEEE Transactions)", en: "Search journals (e.g. Nature, IEEE Transactions)" },
    "journal.field": { ko: "분야", en: "Field" },
    "journal.allFields": { ko: "전체 분야", en: "All fields" },
    "journal.rating": { ko: "등급", en: "Rating" },
    "journal.allRatings": { ko: "전체 등급", en: "All ratings" },
    "journal.th.title": { ko: "Journal Title", en: "Journal Title" },
    "journal.th.sjr": { ko: "SJR", en: "SJR" },
    "journal.basis": { ko: "Field (industry view) 기준 · {label}", en: "Field (industry view) basis · {label}" },
    "journal.source": {
      ko: "※ 제공된 「최우수/우수 저널 목록」(Field, industry view)을 기준으로 하며, 위의 기준 연도 메뉴에서 연도별 목록을 선택해 열람할 수 있습니다.",
      en: "※ Based on the provided Top-tier / Excellent Journals list (Field, industry view). Use the Reference year menu above to browse each year's list.",
    },
    "dash.jtile.total": { ko: "전체 저널", en: "Total Journals" },
    "dash.jtile.avgSjr": { ko: "평균 SJR", en: "Average SJR" },
    "dash.jtile.sjrProvided": { ko: "SJR 제공 {n}개", en: "{n} with SJR" },
    "aria.dashKind": { ko: "대시보드 종류", en: "Dashboard type" },
    "aria.journalFilter": { ko: "저널 필터", en: "Journal filters" },
    "aria.aiFilter": { ko: "AI Expert 필터", en: "AI Expert filters" },
